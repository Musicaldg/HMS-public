...
from hms_api.engine.sql import SQLDialect, create_sql_dialect
from hms_api.engine.sql.postgresql import PostgreSQLDialect
...
class TestOracleDialect:
    @pytest.fixture()
    def d(self):
        from hms_api.engine.sql.oracle import OracleDialect
...
class TestConfig:
    def test_database_backend_field_exists(self):
        ...
        field_names = {f.name for f in dataclasses.fields(HMSConfig)}
