        ...
        try:
            ...
            if any(
                ...
                raise ValueError(
                    ...
                    f"  2. Decrease HMS_API_RETAIN_MAX_COMPLETION_TOKENS to a value your model supports\n"
...
async def _extract_facts_with_auto_split(
    ...
    Args:
        ...
        config: Resolved HMSConfig for this bank
...
async def extract_facts_from_text(
    ...
    # (see https://github.com/hms-memory/hms/issues/1412).
    tasks = [
        _extract_facts_with_auto_split(
            chunk=chunk,
            chunk_index=i,
